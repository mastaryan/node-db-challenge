...
Relational databases have information stored on tabular tabled groups into columns and rows. SQL puts the data in order to retrieve something stored in teh relational database.
